// ============================================================================
// MS Project Prep Hub — Módulo de Gamificação (js/games.js)
...
// Motor idêntico ao do DP-900/AZ-900/AI-901 Prep Hub; apenas o conteúdo
// (palavras, pares, dicas) foi adaptado ao vocabulário do Microsoft Project.
// ============================================================================
...
const Games = (() => {
  ...
  const CROSSWORD_DATA = {
    size: 10,
    words: [
      { num: 1, word: "EAP", clue: "Sigla para a decomposição hierárquica do escopo total do projeto em pacotes de trabalho.", row: 0, col: 0, dir: "down" },
      { num: 2, word: "GANTT", clue: "Sobrenome do engenheiro que dá nome ao gráfico de barras mais usado para visualizar cronogramas.", row: 0, col: 2, dir: "across" },
      { num: 3, word: "MARCO", clue: "Evento de duração zero que sinaliza um ponto de controle importante no cronograma.", row: 2, col: 2, dir: "across" },
      { num: 4, word: "RECURSO", clue: "Pessoa, equipamento ou material necessário para executar uma tarefa do projeto.", row: 4, col: 0, dir: "across" },
      { num: 5, word: "FOLGA", clue: "Tempo que uma tarefa pode atrasar sem impactar a data final do projeto.", row: 5, col: 1, dir: "down" },
      { num: 6, word: "NIVELAR", clue: "Técnica usada para resolver a superalocação de um recurso, ajustando as datas de suas tarefas.", row: 6, col: 3, dir: "across" },
    ]
  };
  ...
  const Crossword = {
    render(container, onComplete) {
      ...
      const title = el("h3", "game-title", "🧩 Cruzadinha MS Project");
  ...
  const WORDSEARCH_WORDS = [
    "GANTT", "CRONOGRAMA", "RECURSO", "CUSTO", "MARCO", "ESCOPO",
    "PROJETO", "LINHABASE", "FOLGA", "TAREFA", "DEPENDENCIA", "CAMINHOCRITICO"
  ];
  ...
  const WordSearch = {
    render(container, onComplete) {
      ...
      wrap.append(el("h3", "game-title", "🔍 Caça-Palavras — Microsoft Project"));
  ...
  const DRAGDROP_SETS = [
    {
      ...
      pairs: [
        ["EAP", "Decomposição hierárquica de todo o escopo do projeto em pacotes de trabalho gerenciáveis"],
        ["Marco", "Evento de duração zero que sinaliza um ponto de controle importante no cronograma"],
        ["Stakeholder", "Qualquer indivíduo ou grupo que pode afetar ou ser afetado pelo projeto"],
        ["Restrição Tripla", "O equilíbrio entre escopo, tempo e custo que orienta o planejamento do projeto"],
        ["Linha de Base", "A versão aprovada do plano, usada como referência para medir o progresso real"],
        ["Termo de Abertura", "Documento que autoriza formalmente a existência do projeto e o poder do gerente"],
      ]
    },
    {
      title: "Interface e Configuração do MS Project",
      pairs: [
        ["Gráfico de Gantt", "Visualização padrão que combina tabela de tarefas com barras de tempo"],
        ["Calendário do Projeto", "Define os dias e horários de trabalho padrão usados nos cálculos de cronograma"],
        ["Linha do Tempo", "Visão resumida e visual do cronograma, ideal para apresentações executivas"],
        ["Faixa de Opções", "A barra superior com guias que agrupa os comandos do MS Project por categoria"],
        ["Planilha de Recursos", "Visão tabular onde se cadastram e configuram todos os recursos do projeto"],
        ["Arquivo .mpp", "Formato nativo usado para salvar um projeto no Microsoft Project"],
      ]
    },
    {
      title: "Tarefas e Cronograma",
      pairs: [
        ["Caminho Crítico", "Sequência de tarefas dependentes que determina a menor duração possível do projeto"],
        ["Folga", "Tempo que uma tarefa pode atrasar sem impactar a data final do projeto"],
        ["Predecessora", "Tarefa que deve ocorrer antes de outra, de acordo com a dependência lógica"],
        ["Lag", "Intervalo de tempo adicional inserido entre uma tarefa e sua sucessora"],
        ["Tarefa de Resumo", "Tarefa que agrupa e resume automaticamente os dados de suas subtarefas"],
        ["Fast Tracking", "Técnica que sobrepõe tarefas sequenciais para reduzir a duração total do projeto"],
      ]
    },
    {
      title: "Recursos e Custos",
      pairs: [
        ["Superalocação", "Quando um recurso é atribuído a mais trabalho do que sua capacidade permite"],
        ["Taxa Padrão", "Valor cobrado por hora pelo trabalho normal de um recurso, dentro do horário regular"],
        ["Nivelamento", "Processo que redistribui o trabalho de recursos superalocados, podendo atrasar tarefas"],
        ["Custo Fixo", "Valor monetário digitado diretamente na tarefa, independente dos recursos atribuídos"],
        ["Recurso Material", "Tipo de recurso consumido em unidades, como metros de cabo ou sacos de cimento"],
        ["CPI", "Índice que mede a eficiência de custo, calculado como Valor Agregado dividido pelo Custo Real"],
      ]
    }
  ];
