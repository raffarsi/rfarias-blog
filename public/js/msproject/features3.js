...
const INTERACTIVE_LABS = (function() {
  ...
  const msprojectLabs = [
    {
      id: 'ilab-msproject-01',
      title: 'Criar e configurar um projeto no MS Project',
      domain: 'Interface, Configuração e Calendário do MS Project',
      intro: 'Neste lab simulado você vai tomar as decisões corretas para criar e configurar um projeto do zero no MS Project.',
      steps: [
        {
          instruction: 'Você está criando um projeto de implantação de sistema que começa em 15/10/2026. Como definir isso no MS Project?',
          type: 'choice',
          options: [
            'Digitar a data diretamente na primeira tarefa',
            'Arquivo → Informações do Projeto → Data de Início: 15/10/2026',
            'Inserir uma tarefa "Início do projeto" com a data',
            'Não é possível definir data de início no MS Project',
          ],
          correct: 1,
          feedback: 'Correto! A data de início do projeto é configurada em Arquivo → Informações do Projeto. Isso define o ponto de partida para todo o cronograma e afeta o cálculo automático de todas as tarefas.',
        },
        {
          instruction: 'Seu projeto não funciona nos feriados nacionais de 2026. Como configurar isso no MS Project?',
          type: 'choice',
          options: [
            'Marcar as tarefas que caem em feriados manualmente',
            'Projeto → Alterar Período de Trabalho → adicionar os feriados como exceções no calendário',
            'Não é possível excluir feriados no MS Project',
            'Criar uma tarefa "Feriado" para cada data',
          ],
          correct: 1,
          feedback: 'Correto! Em Projeto → Alterar Período de Trabalho, você adiciona exceções (feriados, recessos) para que o MS Project não aloque trabalho nessas datas. O calendário é a base de todo o cronograma.',
        },
        {
          instruction: 'Qual é a diferença entre "Duração" e "Trabalho" de uma tarefa no MS Project?',
          type: 'choice',
          options: [
            'São sinônimos no MS Project',
            'Duração é o tempo de calendário (ex: 3 dias); Trabalho é o esforço em horas-homem (ex: 24h para 1 recurso × 3 dias)',
            'Duração é para tarefas manuais; Trabalho é para tarefas automáticas',
            'Trabalho é sempre maior que Duração',
          ],
          correct: 1,
          feedback: 'Correto! Duração é o tempo que a tarefa ocupa no calendário. Trabalho é o esforço total em horas. Uma tarefa de 1 dia com 2 recursos tem 1 dia de duração mas 16h de trabalho.',
        },
        {
          instruction: 'Você quer ver o projeto como linha do tempo visual com barras horizontais. Qual modo de exibição usar?',
          type: 'choice',
          options: ['Planilha de Recursos', 'Diagrama de Rede', 'Gráfico de Gantt', 'Uso da Tarefa'],
          correct: 2,
          feedback: 'Correto! O Gráfico de Gantt é a visualização padrão do MS Project — mostra tarefas como barras horizontais numa linha do tempo, com dependências entre elas. É a visão mais usada para acompanhamento.',
        },
      ],
    },
    {
      id: 'ilab-msproject-02',
      title: 'Criar dependências e caminho crítico',
      domain: 'Tarefas, Cronograma e Dependências',
      intro: 'Dependências entre tarefas e o caminho crítico são conceitos fundamentais do MS Project. Pratique aqui.',
      steps: [
        {
          instruction: 'A tarefa "Instalar servidor" só pode começar depois que "Comprar servidor" estiver 100% concluída. Qual tipo de dependência usar?',
          type: 'choice',
          options: ['Início-a-Início (SS)', 'Término-a-Início (FS — Finish-to-Start)', 'Término-a-Término (FF)', 'Início-a-Término (SF)'],
          correct: 1,
          feedback: 'Correto! Término-a-Início (FS) é o tipo mais comum: a tarefa sucessora só começa quando a predecessora termina. É a dependência padrão no MS Project.',
        },
        {
          instruction: 'O que é o Caminho Crítico em um projeto?',
          type: 'choice',
          options: [
            'As tarefas mais difíceis tecnicamente do projeto',
            'A sequência de tarefas com folga zero — qualquer atraso nelas atrasa o projeto inteiro',
            'As tarefas com maior custo do projeto',
            'As tarefas atribuídas ao gerente de projeto',
          ],
          correct: 1,
          feedback: 'Correto! O Caminho Crítico é a sequência de tarefas com folga zero. Se qualquer tarefa crítica atrasar, o projeto inteiro atrasa. No MS Project, tarefas críticas aparecem em vermelho no Gantt.',
        },
        {
          instruction: 'Você adicionou uma nova tarefa e o projeto ficou 5 dias mais longo. O que verificar primeiro?',
          type: 'choice',
          options: [
            'Os recursos alocados às tarefas',
            'Se a nova tarefa entrou no Caminho Crítico',
            'O orçamento do projeto',
            'As permissões do arquivo',
          ],
          correct: 1,
          feedback: 'Correto! Se o projeto ficou mais longo, a nova tarefa entrou no Caminho Crítico. Avalie se pode reduzir sua duração (menos escopo, mais recursos) ou se há tarefas paralelas que absorvam o impacto.',
        },
      ],
    },
    {
      id: 'ilab-msproject-03',
      title: 'Gerenciar recursos e custos',
      domain: 'Recursos, Custos e Atribuições',
      intro: 'Neste lab você vai tomar decisões sobre alocação de recursos e controle de custos no MS Project.',
      steps: [
        {
          instruction: 'Um desenvolvedor está alocado a 150% em uma semana. Como o MS Project indica isso?',
          type: 'choice',
          options: [
            'O MS Project não permite alocação acima de 100%',
            'O recurso fica marcado em vermelho no Gráfico de Gantt e na Planilha de Recursos',
            'Uma mensagem de erro aparece e impede salvar',
            'O MS Project redistribui automaticamente as tarefas',
          ],
          correct: 1,
          feedback: 'Correto! O MS Project permite superalocação mas a indica visualmente em vermelho. O gerente pode então nivelar os recursos manualmente ou usar o Nivelamento Automático (Recurso → Nivelar Todos).',
        },
        {
          instruction: 'Para calcular o custo total do projeto automaticamente, o que você deve configurar primeiro?',
          type: 'choice',
          options: [
            'O orçamento total na capa do projeto',
            'A Taxa Padrão (Standard Rate) de cada recurso na Planilha de Recursos',
            'O tipo de tarefa como "Custo Fixo"',
            'O MS Project não calcula custos automaticamente',
          ],
          correct: 1,
          feedback: 'Correto! Na Planilha de Recursos, você define a Taxa Padrão (ex: R$ 150/h) de cada recurso. O MS Project multiplica pela quantidade de horas alocadas, calculando automaticamente o custo total.',
        },
        {
          instruction: 'Para que serve salvar a Linha de Base (Baseline) do projeto?',
          type: 'choice',
          options: [
            'Para fazer backup do arquivo',
            'Para comparar o plano original com o progresso real — identificando desvios de prazo e custo',
            'Para compartilhar o projeto com a equipe',
            'Para calcular o caminho crítico',
          ],
          correct: 1,
          feedback: 'Correto! A Linha de Base congela o plano original (datas, durações, custos). Conforme o projeto avança, você compara o realizado com a baseline para identificar desvios. No Gantt com Tracking, você vê barras duplas: planejado vs realizado.',
        },
      ],
    },
  ];
